...
const BackgroundPreview = styled.div.withConfig({
  shouldForwardProp: (prop) => prop !== 'selected' && prop !== 'imageUrl' && prop !== 'label'
})`
  width: 140px;
  height: 90px;
  border-radius: 12px;
...
const CustomBackgroundPreview = styled(BackgroundPreview).withConfig({
  shouldForwardProp: (prop) => prop !== 'customImageUrl'
})`
  display: flex;
  flex-direction: column;
  align-items: center;
      ...
      <SettingsSection theme={theme}>
        ...
        <OptionGroup>
          ...
          <SystemInfoCard theme={theme}>
            ...
            <SystemInfoValue theme={theme}>v0.1.9</SystemInfoValue>
            
            <LinkButtonContainer>
              <LinkButton
                onClick={() => {
                  if (typeof window !== 'undefined') {
                    window.open('https://github.com/Polonium-salts/OpenStore', '_blank');
                  }
                }}
                title="访问GitHub仓库"
              >
              ...
              <LinkButton
                onClick={() => {
                  if (typeof window !== 'undefined') {
                    window.open('https://store.cereals.fun/', '_blank');
                  }
                }}
                title="访问官网"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <path d="m3 12c0-4.97 4.03-9 9-9s9 4.03 9 9-4.03 9-9 9-9-4.03-9-9z"></path>
                </svg>
                官网
              </LinkButton>
            </LinkButtonContainer>
